...
# Helper function: identify Tukey outliers in a numeric vector
...
buggy_tukey_multiple <- function(x) {
...
# Run buggy function
buggy_tukey_multiple(test_mat)

# Corrected version with defensive checks
